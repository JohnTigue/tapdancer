...
# Before this code was actually deployed at a once-a-munute scheduled
# AWS Labmda, the code was actually run via cron on localhost. This
# is how things were invoked via cron/

# This is simply to set up PATH so that cron can run the
# chucks_parser.js to build a new menu in html (and scrape
# chuckscd.com)
